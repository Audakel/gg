...
class bachelorEvents extends StatefulWidget {
  String idUser;
  bachelorEvents({this.idUser});

  _bachelorEventsState createState() => _bachelorEventsState();
}

class _bachelorEventsState extends State<bachelorEvents> {
  ///
